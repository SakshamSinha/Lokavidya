...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "lokavidya@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "lokavidya API";

        private String description = "lokavidya API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "lokavidya";
